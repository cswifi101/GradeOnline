...
<!--type,text,name,NAME,required,true,errMsg,กรุณากรอก เฉพาะชื่อนักศึกษาอย่างเดียว "วสันต์-->
<!--end_of_saved_settings-->
	...
	if (theForm['NAME'].value == ""){
		errMsg = "กรุณากรอก เฉพาะชื่อนักศึกษาอย่างเดียว \"วสันต์";
		setfocus = "['NAME']";
	}
	if (errMsg != ""){
		alert(errMsg);
...
<!--start_of_saved_settings-->
<!--type,text,name,ID,required,true,isNum,errMsg,กรุณากรอกรหัสนักศึกษาครับ  เช่น 5913000223-->
<!--end_of_saved_settings-->
	...
	if (!numRE.test(theForm['ID'].value)){
		errMsg = "กรุณากรอกรหัสนักศึกษาครับ  เช่น 5923000223";
		setfocus = "['ID']";
	}
	if (errMsg != ""){
		alert(errMsg);
...
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		...
		<div id="no1" class="col-lg-12 col-xs-12"  >
			<br><div class="row">
					<div  class="col-lg-offset-2  col-lg-8   col-lg-offset-2   col-xs-offset-2  col-xs-8 col-xs-offset-2  " style="background-color:#00FF00; border:5px solid #000000; border-radius:20px;  border-bottom-right-radius:15px;border-bottom-left-radius:15px;" >  
							<BR><BR><fieldset>
								<div  class="col-lg-12 col-sm-12 col-xs-12">
									<span class="block input-icon input-icon-right">
									<center> 
									<font size="4">ระบบดูผลการเรียนออนไลน์   ระดับมัธยมศึกษาตอนปลาย
...
<br> 
	...
	<!--ค้นหาโดยรหัสนักศึกษา-->
								<div  class="col-lg-12  col-xs-12">						
									<form action="3show_gade.php" method="post" enctype="multipart/form-data" name="form2" onSubmit="VF_form2();return false;">
									<font size="2"> 
									<input name="ID" type="text" id="ID" class="col-lg-offset-1 col-lg-10 col-sm-offset-3 col-sm-6  col-xs-offset-3 col-xs-6" placeholder="รหัสนักศึกษา เช่น 5921002709"  maxlength="10" onKeyPress="Check_num(event);" >
										<BR><BR><br>
