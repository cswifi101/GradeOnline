...
$query_Recordset1 = "SELECT `2student`.PRENAME, `2student`.NAME, `2student`.SURNAME, `2student`.FA_PRENAME, `2student`.FA_NAME, `2student`.FA_SURNAME, `2student`.MO_PRENAME, `2student`.MO_NAME, `2student`.MO_SURNAME, `2student`.STD_CODE, `2student`.CARDID, `2grade`.SEMESTRY, `2grade`.SUB_CODE, `2grade`.TOTAL, `2grade`.GRADE, `2subject`.SUB_NAME, `2subject`.SUB_CREDIT, `2student`.ID FROM `2student`, `2grade`, `2subject` WHERE `2student`.ID = '$ID' AND `2student`.STD_CODE AND `2student`.STD_CODE=`2grade`.STD_CODE AND `2grade`.SUB_CODE=`2subject`.SUB_CODE ORDER BY `2grade`.SEMESTRY ASC";
$Recordset1 = mysql_query($query_Recordset1, $Connect) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysql_num_rows($Recordset1);

mysql_select_db($database_Connect, $Connect);
$query_Recordset2 = "SELECT `2activity`.SEMESTRY, `2activity`.ACTIVITY, `2activity`.`HOUR` FROM `2student`, `2activity` WHERE `2student`.ID='$ID' AND `2student`.STD_CODE=`2activity`.STD_CODE";
...
<table width="1033" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
    ...
    <td><br><br>
	  ...
	  <div class="col-sm-12" align="center"><img src="logo.jpg" width="10%" /></div>
        <p><span class="style15"><font size="2"><strong>ใบแสดงผลการเรียน หลักสูตรการศึกษานอกระบบระดับการศึกษาขั้นพื้นฐาน 
          <span class="style16">ระดับมัธยมศึกษาตอนต้น</span><br>
  ...
  ?>
	  ...
	  if(($i%2)==0)
        ...
        <tr> 
          <td colspan="3" bgcolor="#FF0000" class="style22"><div align="right"><font color="#FFFFFF" size="2">รวม</font></div></td>
          <td bgcolor="#FF0000" class="style35 style6 style25"><div align="center"><font color="#FFFFFF" size="2"><strong><?php echo $sum_atc;  ?>&nbsp;</strong></font></div></td>
        </tr>
      </table>
      <p><br>
