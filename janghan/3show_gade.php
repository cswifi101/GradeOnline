...
$query_Recordset1 = "SELECT `3student`.PRENAME, `3student`.NAME, `3student`.SURNAME, `3student`.FA_PRENAME, `3student`.FA_NAME, `3student`.FA_SURNAME, `3student`.MO_PRENAME, `3student`.MO_NAME, `3student`.MO_SURNAME, `3student`.STD_CODE, `3student`.CARDID, `3grade`.SEMESTRY, `3grade`.SUB_CODE, `3grade`.TOTAL, `3grade`.GRADE, `3subject`.SUB_NAME, `3subject`.SUB_CREDIT, `3student`.ID FROM `3student`, `3grade`, `3subject` WHERE `3student`.ID=$ID AND `3student`.STD_CODE=`3grade`.STD_CODE AND `3grade`.SUB_CODE=`3subject`.SUB_CODE ORDER BY `3grade`.SEMESTRY ASC";
$Recordset1 = mysql_query($query_Recordset1, $Connect) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysql_num_rows($Recordset1);

mysql_select_db($database_Connect, $Connect);
$query_Recordset2 = "SELECT `3activity`.SEMESTRY, `3activity`.ACTIVITY, `3activity`.`HOUR` FROM `3student`, `3activity` WHERE `3student`.ID='$ID' AND `3student`.STD_CODE=`3activity`.STD_CODE";
    ...
    <td><br><br>
	  ...
	  <div class="col-sm-12" align="center"><img src="logo.jpg" width="10%" /></div>
        <p><span class="style15"><font size="2"><strong>ใบแสดงผลการเรียน หลักสูตรการศึกษานอกระบบระดับการศึกษาขั้นพื้นฐาน 
          <span class="style16">ระดับมัธยมศึกษาตอนปลาย</span><br>
