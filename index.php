...
<html lang="en">
	<head>
	<title>ระบบตรวจสอบผลการเรียนออนไลน์  กศน.อำเภอจังหาร จังหวัดร้อยเอ็ด  | itw 2.0 </title>
		...
		<meta name="keywords" content="ระบบตรวจสอบผลการเรียนออนไลน์  กศน.อำเภอจังหาร จังหวัดร้อยเอ็ด"/>
...
<marquee behavior="scroll" scrolldelay="100" onmouseover="this.stop();" onmouseout="this.start(); "id="hot-news">
	ระบบตรวจสอบผลการเรียนออนไลน์  กศน.อำเภอจังหาร จังหวัดร้อยเอ็ด
	</marquee>				</div>
				<div class="navbar-buttons navbar-header pull-right" role="navigation">
					<ul class="nav ace-nav">
						...
						<li class="transparent">
							<a class="dropdown-toggle" href="https://www.facebook.com/CsWifi/">
								<i class="ace-icon fa fa-facebook icon-animated-bell"></i>
							</a>
						</li>
								
						<li class="transparent">
							<a class="dropdown-toggle" href="https://www.youtube.com/?gl=TH&tab=r11">
							...
							<div class="col-xs-12">
								...
								<div  class="col-lg-12 col-sm-12 col-xs-12">	<BR><BR>					
									...
									<select id="amp"  class="col-lg-offset-1 col-lg-10  col-xs-offset-1 col-xs-10" onchange="goToSite(this);">
										...
										<option value="http://127.0.0.1/GradeOnline/janghan">กศน.อำเภอ จังหาร</option>
										<option value="http://127.0.0.1/GradeOnline/janghan">กศน.ตำบล ดินดำ</option>
										<option value="http://127.0.0.1/GradeOnline/janghan">กศน.ตำบล ปาฝา</option>
										<option value="http://127.0.0.1/GradeOnline/janghan">กศน.ตำบล ม่วงลาด</option>
										<option value="http://127.0.0.1/GradeOnline/janghan">กศน.ตำบล จังหาร</option>
                                        <option value="http://127.0.0.1/GradeOnline/janghan">กศน.ตำบล ดงสิงห์</option>
                                        <option value="http://127.0.0.1/GradeOnline/janghan">กศน.ตำบล ยางใหญ่</option>
										<option value="http://127.0.0.1/GradeOnline/janghan">กศน.ตำบล ผักแว่น</option>
										<option value="http://127.0.0.1/GradeOnline/janghan">กศน.ตำบล แสนชาติ</option>
									</select>
									<BR><br>
...
<div class="row" style="margin-top:5px;">
<div class="col-sm-12" align="center"><a href="http://roiet.nfe.go.th:1234/4619/"><img src="assets/images/nfe_foot.jpg" width="1005" /></a></div>
</div>
</div>
